...
permalink: /react-js-for-rails-developers-part-1/
...
2. React.js - tutorial для Rails разработчиков (часть 2)

Во второй части я напишу про `setState/replaceState`, удаление и редактирование записей, рефакторинг и `Reactive Data Flow`.
